...
- `src/shieldops/audit/` — Configuration audit trail, audit intelligence, decision audit, audit_readiness, compliance_reporter, evidence_tracker, finding_tracker
