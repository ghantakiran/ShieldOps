...
- `src/shieldops/knowledge/` — Knowledge base article management, knowledge decay, contribution tracker, freshness_monitor, search_optimizer, usage_analyzer, knowledge_coverage, expertise_mapper, feedback_loop, taxonomy_manager
