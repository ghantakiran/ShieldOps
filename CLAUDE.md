...
- `src/shieldops/policy/` — OPA policies, approval logic, tenant isolation, cross-agent policy enforcer, governance dashboard
...
- `src/shieldops/compliance/` — Compliance automation, gap analysis, license scanning, access certification, evidence chain, compliance drift detector, policy violation tracker, evidence scheduler, evidence freshness monitor, audit trail analyzer, license risk, policy impact, evidence automator, posture scorer
