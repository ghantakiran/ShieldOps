...
- **Observability Intelligence Agent:** Multi-signal observability — signal collection, correlation, insights, recommendations
- **XDR Agent:** Extended detection & response — cross-domain telemetry, threat correlation, attack stories, coordinated response
- **Intelligent Automation Agent:** ML-driven automation — situation assessment, strategy selection, execution, validation
