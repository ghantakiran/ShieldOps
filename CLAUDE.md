...
## Key File Paths
- `src/shieldops/agents/` — Agent implementations (investigation, remediation, security, learning, cost, prediction, supervisor, soc_analyst, threat_hunter, forensics, deception), swarm coordinator, consensus engine, knowledge mesh, token optimizer, prompt cache, routing optimizer, telemetry analyzer, compliance auditor
