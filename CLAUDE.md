...
- `src/shieldops/audit/` — Configuration audit trail, audit intelligence, decision audit, audit_readiness, compliance_reporter, evidence_tracker
...
- `src/shieldops/knowledge/` — Knowledge base article management, knowledge decay, contribution tracker, freshness_monitor, search_optimizer, usage_analyzer
