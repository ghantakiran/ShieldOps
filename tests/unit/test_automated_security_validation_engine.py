"""Tests for AutomatedSecurityValidationEngine."""

from __future__ import annotations

from shieldops.security.automated_security_validation_engine import (
    AutomatedAnalysis,
    AutomatedLevel,
    AutomatedRecord,
    AutomatedReport,
    AutomatedSecurityValidationEngine,
    AutomatedSource,
    AutomatedType,
)


def _engine(**kw) -> AutomatedSecurityValidationEngine:
    return AutomatedSecurityValidationEngine(**kw)
