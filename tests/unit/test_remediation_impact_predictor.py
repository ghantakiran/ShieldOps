"""Tests for shieldops.operations.remediation_impact_predictor — RemediationImpactPredictor."""

from __future__ import annotations

from shieldops.operations.remediation_impact_predictor import (
    RemediationAnalysis,
...
def _engine(**kw) -> RemediationImpactPredictor:
    return RemediationImpactPredictor(**kw)
