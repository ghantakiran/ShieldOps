"""Tests for SecurityFrameworkAlignmentTracker."""

from __future__ import annotations

from shieldops.compliance.security_framework_alignment_tracker import (
    SecurityAnalysis,
...
def _engine(**kw) -> SecurityFrameworkAlignmentTracker:
    return SecurityFrameworkAlignmentTracker(**kw)
