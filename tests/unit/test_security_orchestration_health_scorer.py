"""Tests for SecurityOrchestrationHealthScorer."""

from __future__ import annotations

from shieldops.security.security_orchestration_health_scorer import (
    SecurityAnalysis,
    SecurityLevel,
    SecurityOrchestrationHealthScorer,
    SecurityRecord,
    SecurityReport,
    SecuritySource,
    SecurityType,
...
def _engine(**kw) -> SecurityOrchestrationHealthScorer:
    return SecurityOrchestrationHealthScorer(**kw)
