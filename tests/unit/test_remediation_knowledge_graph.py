"""Tests for shieldops.operations.remediation_knowledge_graph — RemediationKnowledgeGraph."""

from __future__ import annotations

from shieldops.operations.remediation_knowledge_graph import (
    RemediationAnalysis,
...
def _engine(**kw) -> RemediationKnowledgeGraph:
    return RemediationKnowledgeGraph(**kw)
