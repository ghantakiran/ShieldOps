"""Tests for SecurityAutomationMaturityScorer."""

from __future__ import annotations

from shieldops.analytics.security_automation_maturity_scorer import (
    SecurityAnalysis,
...
def _engine(**kw) -> SecurityAutomationMaturityScorer:
    return SecurityAutomationMaturityScorer(**kw)
