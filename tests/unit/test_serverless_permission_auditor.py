"""Tests for shieldops.security.serverless_permission_auditor — ServerlessPermissionAuditor."""

from __future__ import annotations

from shieldops.security.serverless_permission_auditor import (
    ServerlessAnalysis,
    ServerlessLevel,
...
def _engine(**kw) -> ServerlessPermissionAuditor:
    return ServerlessPermissionAuditor(**kw)
