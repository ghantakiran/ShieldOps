...
class AutomationRecord(BaseModel):
    ...
    name: str = ""
    record_type: AutomationType = AutomationType.METRIC
    source: AutomationSource = AutomationSource.TELEMETRY
    level: AutomationLevel = AutomationLevel.NORMAL
    score: float = 0.0
    service: str = ""
    team: str = ""
...
class AutomationAnalysis(BaseModel):
    id: str = Field(default_factory=lambda: str(uuid.uuid4()))
    name: str = ""
    analysis_type: AutomationType = AutomationType.METRIC
...
class AutomationEffectivenessTracker:
    """Track security automation effectiveness and ROI metrics."""
    ...
    def __init__(
        ...
        logger.info(
            "automation_effectiveness_tracker.initialized",
    ...
    def record(
        ...
        logger.info(
            "automation_effectiveness_tracker.recorded",
            record_id=rec.id,
            name=name,
        )
        return rec

    def get_record(self, record_id: str) -> AutomationRecord | None:
    ...
    def list_records(
        self,
        record_type: AutomationType | None = None,
    ...
    def add_analysis(
        ...
        logger.info(
            "automation_effectiveness_tracker.analysis_added",
            name=name,
            analysis_score=analysis_score,
        )
        return analysis
    ...
    def generate_report(self) -> AutomationReport:
        ...
        if not recs:
            recs.append("AutomationEffectivenessTracker posture is healthy")
    ...
    def clear_data(self) -> dict[str, str]:
        ...
        logger.info("automation_effectiveness_tracker.cleared")
