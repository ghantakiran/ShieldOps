...
class DetectionRecord(BaseModel):
    ...
    name: str = ""
    record_type: DetectionType = DetectionType.METRIC
    source: DetectionSource = DetectionSource.TELEMETRY
...
class DetectionAnalysis(BaseModel):
    id: str = Field(default_factory=lambda: str(uuid.uuid4()))
    name: str = ""
    analysis_type: DetectionType = DetectionType.METRIC
...
class DetectionEngineeringMetrics:
    """Track detection engineering metrics and rule effectiveness."""
    ...
    def __init__(
        ...
        logger.info(
            "detection_engineering_metrics.initialized",
    ...
    def record(
        ...
        logger.info(
            "detection_engineering_metrics.recorded",
            record_id=rec.id,
            name=name,
        )
        return rec
    ...
    def list_records(
        self,
        record_type: DetectionType | None = None,
    ...
    def add_analysis(
        ...
        logger.info(
            "detection_engineering_metrics.analysis_added",
            name=name,
            analysis_score=analysis_score,
        )
        return analysis
    ...
    def generate_report(self) -> DetectionReport:
        ...
        if not recs:
            recs.append("DetectionEngineeringMetrics posture is healthy")
    ...
    def clear_data(self) -> dict[str, str]:
        ...
        logger.info("detection_engineering_metrics.cleared")
