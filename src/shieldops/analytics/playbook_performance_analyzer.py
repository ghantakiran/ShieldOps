...
class PlaybookRecord(BaseModel):
    ...
    name: str = ""
    record_type: PlaybookType = PlaybookType.METRIC
    source: PlaybookSource = PlaybookSource.TELEMETRY
    level: PlaybookLevel = PlaybookLevel.NORMAL
    score: float = 0.0
    service: str = ""
    team: str = ""
...
class PlaybookAnalysis(BaseModel):
    id: str = Field(default_factory=lambda: str(uuid.uuid4()))
    name: str = ""
    analysis_type: PlaybookType = PlaybookType.METRIC
...
class PlaybookPerformanceAnalyzer:
    """Analyze playbook execution performance and success rates."""
    ...
    def __init__(
        ...
        logger.info(
            "playbook_performance_analyzer.initialized",
    ...
    def record(
        ...
        logger.info(
            "playbook_performance_analyzer.recorded",
            record_id=rec.id,
            name=name,
        )
        return rec
    ...
    def add_analysis(
        ...
        logger.info(
            "playbook_performance_analyzer.analysis_added",
            name=name,
            analysis_score=analysis_score,
        )
        return analysis
    ...
    def generate_report(self) -> PlaybookReport:
        ...
        if not recs:
            recs.append("PlaybookPerformanceAnalyzer posture is healthy")
    ...
    def clear_data(self) -> dict[str, str]:
        ...
        logger.info("playbook_performance_analyzer.cleared")
