...
render_page_header(
    "Cost Intelligence", "Cost anomaly detection, optimization, and savings tracking"
)
render_auto_refresh()
    ...
    render_metric_row(
        [
            ...
            (
                ...
                f"{savings.get('hours_saved_by_automation', 0):.0f}h",
                None,
            ),
...
# --- Trigger analysis ---
with tab_trigger, st.form("trigger_cost_analysis"):
