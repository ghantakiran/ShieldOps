...
class ActionRateLimiter:
    ...
    async def count_recent_actions(self, environment: str) -> int:
        ...
        try:
            ...
            count = await client.get(self._key(environment))  # type: ignore[union-attr]
    ...
    async def increment(self, environment: str) -> int:
        ...
        try:
            ...
            count = await client.incr(key)  # type: ignore[union-attr]
            await client.expire(key, 3600)  # type: ignore[union-attr]
            return int(count)
        except Exception as e:
